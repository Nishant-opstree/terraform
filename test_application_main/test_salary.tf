...
module "test_salary_asp_up" {
  ...
  asg_name                      = test_module.test_salary_as.asg.name
}

module "test_salary_cloud_watch_up" {
  ...
  alarm_threshold             = "80"
  alarm_alarm_actions         = [module.test_salary_asp_up.asg_policy.arn]
  alarm_asg_name              = module.test_salary_as.asg.name
}
...
module "test_salary_cloud_watch_down" {
  source                      = "./modules/cloudwatch_metric"
  ...
  alarm_statistic             = "Average"
  alarm_threshold             = "80"
  alarm_alarm_actions         = [module.test_salary_asp_down.asg_policy.arn]
  alarm_asg_name              = module.test_salary_as.asg.name
