...
module "attendance_cloud_watch_up" {
  ...
  alarm_threshold             = "80"
  alarm_alarm_actions         = [module.attendance_asp_up.asg_policy.arn]
  alarm_asg_name              = module.attendance_as.asg.name
}
...
module "attendance_cloud_watch_down" {
  source                      = "./modules/cloudwatch_metric"
  ...
  alarm_statistic             = "Average"
  alarm_threshold             = "80"
  alarm_alarm_actions         = [module.attendance_asp_down.asg_policy.arn]
  alarm_asg_name              = module.attendance_as.asg.name
