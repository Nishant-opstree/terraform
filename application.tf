...
module "frontend_security_group_rules_ingress" {
  ...
  rule_portocol  = "tcp"
  rule_cidr      = ["0.0.0.0/0"]
  rule_sec_grp   = module.frontend_security_group.webapp_sec_grp_Id
}

module "frontend_security_group_rules_egress" {
  source         = "./modules/security_group_rules"
  rule_type      = "egress"
  rule_from_port = "0"
  rule_to_port   = "65535"
...
module "frontend_lc" {
  ...
  security_group_Id = [ module.frontend_security_group.webapp_sec_grp_Id] 
